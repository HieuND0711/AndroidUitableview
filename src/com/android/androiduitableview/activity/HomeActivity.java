...
public class HomeActivity extends Activity {
    ...
    private class CustomClickListener implements ClickListener {
		...
		public void onClick(int index) {
			...
			if(index == 0) {
				Intent i = new Intent(HomeActivity.this, Example1Activity.class);
				startActivity(i);
			}
			else if(index == 1) {
				Intent i = new Intent(HomeActivity.this, Example2Activity.class);
				startActivity(i);				
			}
			else if(index == 2) {
				Intent i = new Intent(HomeActivity.this, Example3Activity.class);
				startActivity(i);				
			}
			else if(index == 3) {
				Intent i = new Intent(HomeActivity.this, Example4Activity.class);
				startActivity(i);				
			}
			else if(index == 4) {
				Intent i = new Intent(HomeActivity.this, Example5Activity.class);
				startActivity(i);				
			}
			else if(index == 5) {
				Intent i = new Intent(HomeActivity.this, Example6Activity.class);
				startActivity(i);				
			}
			else if(index == 6) {
				Intent i = new Intent(HomeActivity.this, Example7Activity.class);
				startActivity(i);				
			}
			else if(index == 7) {
				tableView.clear();		
